...
.SYNOPSIS
    PowerShell script to update the IPv6 Interface Metric value in raspshone.pbk for Always On VPN device tunnel connections.
...
Try {
    ...
    Write-Verbose 'Updating Ipv6InterfaceMetric setting in rasphone.pbk...'
    $RasphoneData | ForEach-Object { $_ -Replace 'Ipv6InterfaceMetric=.*', 'Ipv6InterfaceMetric=3' } | Set-Content -Path $RasphonePath -Force
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUddZ/SBEKUiPmg686BALqWLnH
# LrWggiDHMIIFjTCCBHWgAwIBAgIQDpsYjvnQLefv21DiCEAYWjANBgkqhkiG9w0B
...
# DQEJBDEWBBQQ4K+tGXorwZr7lc0qBL98AcidgTANBgkqhkiG9w0BAQEFAASCAYBs
# dkLYEztnag3c0RFzMfDvIx6jxdeAZgaIBfeB9xSKv951aBHdSYV5xkcsoAk9CgBe
# gnUaZHFg9YBwGMG4gkIFodRJMDU+DwNY0uADz3HdjzMFjYwKXCGqtUswcKfJt/tQ
# GT++59fFeVTKZVydo+gzZl5OK1GFRZee4PS42SxiuYTAUVcx/HlXILJq2qSudwt/
# 3LbolLBwqEs2LyePa363XqcRCltysTgcSh14uhdzc577mWdRCSCjECqV9Nqvut42
# o54AIVxbH9HN9jLi/NGpL0znLqf7fNYfGkNz0yQTXr9gQefBaxN9AKahPtFQhPrb
# cdDwI9TtMEaB+gFH6JcmW7c7217uUeNpEk358Ao8pJkdj9Jh6y0PcF+OwrEJkg0E
# ypBM1Is8w7kgba+QYHWMMHCh1j8fIszdj8CeQp2lk/8YlzZtIhZBHj7MFcklr7lY
# w8W5Ce6yjTR/7OK7r4L+OCVhgjUtMO03I7CdTkVn7pnZbeAcD0zMyRUErIfjtCSh
...
# WqnTuhjL7JfDtKt2tlwt+L4tfjszUl4wGkgRS7S2L1wwDQYJKoZIhvcNAQEBBQAE
# ggIACaLfkBzGyyzR0uyioAdv2wnUwjkuWq2sqZbwLuOowaoaYagwwTecxzATFaGi
# w+OUQzhI17GYOLmlZZD4bnr3p3XfYnYQpvHeEy53aeCUChSh/X1wXBt/7DECj0zh
# sMwPnKxs2BrwOuiHa72r+44FDU8ClunNMBlnUIHqUI34PnCGCUCWVxKBEZ+c4Ysi
# yjsHSZfCxGBgn4j+3jPVDI58g6aV3YhYD95St7JfXw3qLSb8jg5mq93dOFxU17En
# FyZhzEeOf4zOE4Wn189Ea1gUxgC3ihpHHZzE7moaHycfG4itz/VBFkknW3UBl30C
# zIsyW3W0bN5VxnuUC9gGG2QwiDYOMLIe+NOg0FJNvbS6dLA4T40IpU369iLVShac
# nmQj0+NoHCM93Z5hQ4upiL51JvxstXAUK5gC/bBKvhlWc6yYCC6YlOpBjgYfk5td
# FKIjnEeaRfbsRnLsreQdIpW0kq5Li5qU9JBmHZpTHr3C3GIf+sjURYkVs3eQcuRO
# o4B5q6Jbuves666nSffJBcCL7BMZohARc2/42VHvsjDG0nziQu8usWnwVxMnSHha
# BQbs0GKvfMx2W2DlsLTMR5MUH2etdT4KcQw1uO0xhzecVa3hS8pC1dWJeVydc77k
# TFHCa29CVo4TmQHCl+wGlPDLKJPOpmKw70SeAYLNKtLTTCE=

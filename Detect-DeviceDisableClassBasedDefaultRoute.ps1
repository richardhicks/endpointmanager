...
.SYNOPSIS
    PowerShell script to detect the value of DisableClassBasedDefaultRoute in raspshone.pbk for Always On VPN device tunnel connections.

.EXAMPLE
    .\Detect-DeviceDisableClassBasedDefaultRoute.ps1
...
Try {
    ...
    $RasphoneData = (Get-Content $RasphonePath | Select-String DisableClassBasedDefaultRoute) | ConvertFrom-StringData

    If ($RasphoneData.DisableClassBasedDefaultRoute -eq '0') {

        Write-Verbose 'DisableClassBasedDefaultRoute set to 0. Remediation required.'
        Exit 1
    ...
    Else { 
        ...
        Write-Verbose 'DisableClassBasedDefaultRoute set to 1. No remediation required.'
        Exit 0
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU226tPITRtXpU39BM+p+y0TZn
# 9aOggiDHMIIFjTCCBHWgAwIBAgIQDpsYjvnQLefv21DiCEAYWjANBgkqhkiG9w0B
...
# DQEJBDEWBBTEwchnrTyohRbY2kWm4Cr2fyv+uzANBgkqhkiG9w0BAQEFAASCAYAZ
# GHy8i2vTc2iZCDSVaW6P2jlGnckDpPbgQCmHf321EGuxbXWxmDjsP2M7DVWNT62z
# XCgcEIBiEqn59mhGB2t1atuuiSwGrVhEbLhMqrId/4ATLKWGtKOvGc5tXSbtHi8e
# cccYpft4pXOnldklxYfzqZDMqMXIt0cnzwC6O3DHgdJZb1WXSCYxoVxSnEzgc5Ga
# /CGp79O31QloLd54mzm44zHz7U9EIvJ9n5WlvQBzywYkw7TQNHs650W8u3MYiMyk
# A7e/gtxVBT3Q6v0ZVeLvVJvGsRrGVU26eTWGhlTOftt1KxvGmNksA4bjEDs6WFP8
# tuL0CanPMpE3KH7lPOwjsUkyr1oIW8fgjtIWdIOz9X8XlybotWwQScRfSdEGxyxk
# kBuyxC9GdqqE3B2SEOcfNFC/eN3T/zJQfy6InGshomAYbKPKHoCdK02RMP+s3goe
# KPRA/MxsAC7d5HPSWXYYZvU+2PmAt58KeiNy5jEZsTAtVIQK4t9CUdhnlfybDJ2h
...
# ATAcBgkqhkiG9w0BCQUxDxcNMjIwODE3MjMxOTIxWjAvBgkqhkiG9w0BCQQxIgQg
# 9de7QlOHUhjCdiJjXd6pf4dtcYTCf1p/SgmiNJ8b620wDQYJKoZIhvcNAQEBBQAE
# ggIAVdYcWnXH2MTCGpNmEz1H7EQluAmCMnAbWEsFkC1PlUCUq2kVm47KKehN5hEB
# SLAlfLY5xuAB1qAxzfCbuZ1xiStrp518+nG8qSkxebUX90QKkK1AmUm1joKmnFzq
# O+u1Ve09YVeMTW+F1lCcQRZvElzPJ1XcIHZREq9Vhv/4RSdpFgFAneW2fPutZ70h
# i7li0dmDesgfeoOm1v6klHHxnbY0ayf7n9O85r8rSP9NmwbXALsNEmWiM7ehR/kr
# tgYALZ/vUkEFy1ZvlQu1lFjI6z5OzjeyADatpKWwzgkqOPByi71YgHJm6RMCBfuA
# 6zOBQZVcsU5OrfWCfcjqNRCHW5zRfHVYHMotcpu0PfjFUrVmfuj920RBigllEo+u
# FUPuUKBm4p3CELKvzRE6gDZmFSj4f8CpqbYufF04Fd5dgLwhNMsE7EeM8tus8b/T
# yQJgmqraZUsZ9FPvFRdv1Rg5gXNxYWZAy2MPKqjDnhNaJ1kZHJNkXhWIakmQ4y1n
# Z3VcPfJ7Uo7UYqKxqEoZi1UCwwLnBo2Nk33DcB3B5+BwzLot1dWXNnETq+6mayZF
# IGiLOZxx5ym1XdiA72S7qzEcwwnOgms3HhzE2h4qupjqzZVwNsqEaKP0O2I7b/AQ
# kqUiHdswwyubeViKr19ZAmppF5owCU5avcrmChN2Hl2SnDY=

...
.SYNOPSIS
    PowerShell script to detect if the Kerberos FarKdcTimeout registry key is set to 0.

.EXAMPLE
    .\Detect-FarKdcTimeout.ps1

.DESCRIPTION
    This PowerShell script is deployed as a detection script using Intune remediations. By default, Windows caches the domain controller used for Kerberos authentication for 10 minutes. Setting the FarKdcTimeout registry key to 0 disables this caching behavior, ensuring Windows always locates the nearest domain controller for Kerberos authentication.

.LINK
    https://github.com/richardhicks/endpointmanager/blob/main/Detect-FarKdcTimeout.ps1
...
Param (
    ...
    $FarKdcTimeout = (Get-ItemProperty -Path 'HKLM:\SYSTEM\CurrentControlSet\Control\Lsa\Kerberos\Parameters\' | Select-Object -ExpandProperty FarKdcTimeout -ErrorAction SilentlyContinue)

)

Try {

    If ($FarKdcTimeout -eq 0) {

        Write-Warning 'The FarKdcTimeout registry key is set to 0. Remediation not required.'
        Exit 0
    ...
    Else {
        ...
        Write-Warning 'The FarKdcTimeout registry key is missing or not set to 0. Remediation required.'
        Exit 1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC99U3i/ilVB2zg
# ZvTrAZwDuCJftzqPs+JfWrbmWqmgJqCCH6YwggWNMIIEdaADAgECAhAOmxiO+dAt
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDAP8nkp+HomeJqUOfcwGVq
# ucUpn2Tta/CNGrBJSG+IQzALBgcqhkjOPQIBBQAERzBFAiEAmhVEpolZXYwVP5Bd
# ahfmICEECNjNF9xpia26QSzMNhQCIDhI49vRZnePZHqZgHA8UhvONXp/pbblcUMx
# /TbPiR/koYIDJjCCAyIGCSqGSIb3DQEJBjGCAxMwggMPAgEBMH0waTELMAkGA1UE
# BhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMUEwPwYDVQQDEzhEaWdpQ2Vy
# dCBUcnVzdGVkIEc0IFRpbWVTdGFtcGluZyBSU0E0MDk2IFNIQTI1NiAyMDI1IENB
# MQIQCoDvGEuN8QWC0cR2p5V0aDANBglghkgBZQMEAgEFAKBpMBgGCSqGSIb3DQEJ
# AzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI2MDgyNjE5NTUwM1owLwYJ
# KoZIhvcNAQkEMSIEIMJ4jzfpHkQ7sHt/H5vvnN1jVUhStYJQKwar0SlV+2+8MA0G
# CSqGSIb3DQEBAQUABIICAL6ArE1ouGXRxiplseq3bdgdfWIAIhtHcA3PiHz3CNtd
# R/MUaieZOQGicsP9av1i+GSRriOX53JoPs7SNkyGA+HH9IRQu/uF0CLZfxzBhz6n
# tO4ng1pW0dAGQ8ue4PgLrEGDrV/XMlMDdX/wHB1+bhh3o66Jeb/t9cUsCuGX/4Sd
# K0dIMS78JNvPyrKO6VeC60Tbf6UB155u451FNxjCUY8ERFJ0sZZt/h6Hf0CILBzH
# uLVQMsTjWVFlgCAgqUzLmeAW+c0PVzCUtwoqbiQ/yN5lXXwSwkSRK91Nm3MhF9rl
# giUB7w3I79y9oMV8cU4chIAZKezYLV1bIj7v4J6QJX4zUXPwKet1ru8J2fprdEoS
# kC1AahPc5nx5AcVwgiVlIzEWoNzSQ8KSWiz9fLRCRhAGGxD6//Ufggb05xnmCObi
# gCpJlJWVrZt0uWuCOnP4zSzNjnJV2lJ5xacMAwyyUT04xoLMHCFHhs6oHmokpftC
# XvtaHjprssISAX2AzSIay1dLAmRgtvPEhCGGO5mBQYOUqkV6QoL9S8DmJEbNXdoU
# +Ogq89nHUelaGff/Q023XRmJf/WeM8iDCJFVXeOGv5nDo5JEXizcRNpH7KR+Gati
# hID5SR+pqhQmcMJLEZ+sNzXR/8luFR0ZRmMOeaSjzeK/4vcW0lV+SW44hTZaIKY1
